# Call this Microsoft 365 API to get a list of all alerts from the past month.
...
def get_alerts():
    ...
    response = requests.get('https://api-eu3.securitycenter.microsoft.com/api/alerts', headers=headers)
    return response.json()
